        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                    <%
                        com.YuanXin.model.Order o=(com.YuanXin.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("dbConn");
                        com.YuanXin.dao.UserDao userDao=new com.YuanXin.dao.UserDao();
                    ...
                    <td class="cart_total">${o.paymentId}
                        <%
                            ...
                            String paymentType=com.YuanXin.model.Payment.findByPaymentId(con,n);
                        %>
